...
<main className="md:pt-48 pt-36 max-h-screen overflow-hidden pb-10 px-4 bg-gradient-to-br from-blue-900 via-indigo-800 to-purple-700 text-white">
  <div className="max-w-7xl mx-auto text-center mb-12 bg">
